...
```
```{r}
sd(holt_linear_trend_errors, na.rm = TRUE)
```
...
```
```{r}
sd(damped_holt_linear_trend_errors, na.rm = TRUE)
```
...
```
```{r}
sd(holt_winters_mult_errors, na.rm = TRUE)
```
...
```
```{r}
sd(holt_winters_add_errors, na.rm = TRUE)
```
